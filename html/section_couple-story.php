...
$timelines = [
    ...
    Mời mọi người xem ảnh cưới của chúng tớ/ chúng cháu <a class="js-click-scroll-to" data-target="#fh5co-gallery">tại đây</a> nhé!'],
];
?>
